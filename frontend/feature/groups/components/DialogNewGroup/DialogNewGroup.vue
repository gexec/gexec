...
const formSchema = z.object({
  ...
  slug: z.string().min(0).max(255).optional(),
})
  ...
  try {
    ...
    if (error) {
      ...
      toast({
        ...
        description:
          'We have encountered an unexpected issue while creating the group. Try again later.',
        variant: 'destructive',
      })
...
<template>
  <Dialog v-model:open="isOpen">
    ...
    <DialogContent class="max-w-lg">
      <DialogHeader>
        <DialogTitle>New groups</DialogTitle>
